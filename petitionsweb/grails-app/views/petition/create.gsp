						...
						<form>
							...
							<fieldset>
								...
								<div class="form-form-element-wrapper">
									<div class="form-item form-item-textfield "
										...
										<div class="form-input textfield">
											<g:textField name="postalAddress"
												class="form-text required form-element-type-textfield" />
										</div>
									</div>
								</div>
							...
							<legend>Петиція</legend>
								...
								<div class="form-form-element-wrapper">
									<div class="form-item form-item-textfield "
										id="edit-middle-name-wrapper">
										<div class="form-label">
											<label for="edit-middle-name">Урл адреса на ресурс з більш детальною інформацією (за наявності)</label>
										</div>
										<div class="form-input textfield">
							...
							<div class="form-form-element-wrapper">
								<div class="form-item form-item-checkbox "
									id="edit-bik-acceptance-wrapper">
									<div class="form-input checkbox">
										<label class="option" for="edit-bik-acceptance"><input
											type="checkbox" name="bik_acceptance"
											id="edit-bik-acceptance" value="1"
											class="form-checkbox required"> Я згоден на передачу
											моїх персональних даних і використання їх у відповідності з
											умовами сайту</label>
									</div>
